...
import com.diahl.keretakitaapp.adapter.HistoryAdapter;
import com.diahl.keretakitaapp.database.DatabaseHelper;
import com.diahl.keretakitaapp.model.HistoryModel;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    public void refreshList() {
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            riwayat = "Berhasil melakukan booking untuk melakukan perjalanan dari " + asal + " menuju " + tujuan + " pada tanggal " + tanggal + ". Jumlah pembelian tiket dewasa sejumlah " + dewasa + " dan tiket anak-anak sejumlah " + anak + " \nwaktu " + waktu + ".";
